...
Tanzu Labs uses the SWIFT methodology, which employs agile and domain-driven design (DDD) principles to iteratively modernize complex systems. This approach allows you to understand, plan and get started on complex modernization in days, not weeks or months. Here’s how we do this:

- Define Objectives and Key Results (OKR). Create a backlog of prioritized user stories tied back to OKR.
...
- Conduct a Boris exercise that models the relationships between capabilities ina system.
...
How do you know what good looks like? We like metrics offered by DevOps Research and Assessment (DORA).Here are a few signals that show your effort is succeeding:
...
### Lets's go!
Waiting to untangle legacy applications that hinder a better customer experience isn’t an option. Together we’ll assess your needs and develop an evidence-based strategy that is tailored to meet your business and IT goals. Then, we’ll get to work. Contact your VMware account team or reach us at tanzu.vmware.com/labs.
